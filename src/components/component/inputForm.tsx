...
const InputForm = ({
  ...
  return (
    ...
    >
      <div className="border flex flex-row relative rounded-full">
        <Plus
      ...
      <input
        ...
        className="w-full p-2 border-2 border-blue-500 outline-none placehoder-gray-500 rounded-full shadow-md focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50 focus:border-blue-500 focus:border-opacity-50 transition duration-300 ease-in-out text-black"
      />
      <button
        type="submit"
